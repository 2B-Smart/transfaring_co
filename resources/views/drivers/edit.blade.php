    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">تعديل السائق</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('drivers.update', $drivers->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('national_id_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2"></div>
                            <div class="col-md-6">
                                <input id="national_id_number" type="text" class="form-control" name="national_id_number" value="{{ $drivers->national_id_number }}" required>
